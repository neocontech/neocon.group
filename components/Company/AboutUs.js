        ...
        <div className="grid grid-cols-3 xsm:grid-cols-1 sm:grid-cols-1 gap-6 pb-20">
          ...
          <div className="col-span-2 xsm:col-span-1 sm:col-span-1">
            ...
            <p className="text-base font-regular text-ngl_gray_3">
              ...
              that offers a range of innovative and advanced software solutions
              to meet the evolving needs of businesses of all sizes. We
              specialize in cutting-edge technology, software development, web
              application development, mobile application development, and IoT,
              Fintech solution.
            </p>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="text-base font-regular text-ngl_gray_3">
              <p>
                ...
                conglomerate, we bring together a diverse range of expertise in
                stock market securities, internet services, and Software Company
                to create a seamless ecosystem that shapes the future.
              </p>
              <p className="py-2">
                Neocon Group is dedicated to delivering exceptional services and
                solutions that meet the evolving needs of our clients. Through
                our network of companies, we offer a comprehensive suite of
                services, including state-of-the-art internet connectivity,
                robust data center infrastructure, and next-generation
                technologies.
              </p>
              <p>
                With our unwavering commitment to excellence, Neocon Group
                fosters a culture of innovation, collaboration, and continuous
                growth. Our talented team of professionals is driven by a shared
                passion for pushing boundaries and embracing emerging trends,
                ensuring that we remain at the forefront of industry
                advancements.
              </p>
            </div>
          </div>
                  ...
                  <div className="flex justify-between xsm:flex-col sm:flex-col">
                    <div className="w-full  p-5">
                      ...
                      <p className="text-base font-regular text-ngl_gray_3">
                        ...
                        digital landscape by empowering individuals, businesses,
                        and industries with innovative solutions. We strive to
                        bridge the gap between technology and practical
                        application, accelerating progress and transforming the
                  ...
                  <div className="flex justify-between xsm:flex-col sm:flex-col">
                    <div className="w-full p-5">
                      ...
                      <p className="text-base font-regular text-ngl_gray_3">
                        ...
                        leadership and cutting-edge technologies. We envision a
                        world where seamless connectivity and advanced solutions
                        enable limitless possibilities, empowering individuals
                        and organizations to thrive in the digital era. Through
                        our relentless pursuit of innovation, collaboration, and
                        excellence, we aspire to shape a future where technology
                        enhances every aspect of human life and propels society
