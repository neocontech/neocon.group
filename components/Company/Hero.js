      ...
      <div className="py-20">
        ...
        <div>
          ...
          <p className="text-base font-regular text-ngl_gray_3 py-5 border-b border-ngl_gray_3">
            Neocon Group is a thriving business consortium, comprising a
            collection of distinct enterprises operating across various
            industries. With a focus on versatility and innovation, we have
            established ourselves as a prominent player in the corporate
            landscape.
          </p>
        </div>
      </div>
